...
const BESTIARY = {
  topo_grigio: {
    ...
    maxHp: 9, ac: 12, ai: 'weakest', undead: true,
    attack: { name: 'Morso di cenere', bonus: 3, dice: [1, 6], plus: 0 },
  ...
  manichino_vita: {
    ...
    attack: { name: 'Abbraccio di cartone', bonus: 3, dice: [1, 8], plus: 1 },
  ...
  divorente: {
    ...
    maxHp: 26, ac: 13, ai: 'strongest', undead: true, boss: true,
    attack: { name: 'Cuscini con dentro i denti', bonus: 4, dice: [1, 10], plus: 2 },
  ...
  sciame_bollette: {
    ...
    maxHp: 12, ac: 14, ai: 'smart', undead: true,
    attack: { name: 'Taglio di carta (con more)', bonus: 4, dice: [1, 6], plus: 1 },
  ...
  monologante: {
    ...
    maxHp: 22, ac: 12, ai: 'random', undead: true,
    attack: { name: 'Aneddoto senza uscita', bonus: 3, dice: [1, 8], plus: 2 },
  ...
  hostess: {
    ...
    maxHp: 18, ac: 14, ai: 'weakest', undead: true,
    attack: { name: 'Dimostrazione di sicurezza', bonus: 4, dice: [1, 8], plus: 1 },
  ...
  luca_giunti: {
    ...
    maxHp: 30, ac: 14, ai: 'smart', undead: true, boss: true,
    attack: { name: 'Richiesta all\'ultimo minuto', bonus: 5, dice: [2, 6], plus: 1 },
  ...
  cosa_sommersa: {
    ...
    maxHp: 28, ac: 13, ai: 'strongest', undead: true, boss: true,
    attack: { name: 'Presa dal fondale', bonus: 5, dice: [2, 6], plus: 1 },
  ...
  bibliotecario: {
    ...
    maxHp: 24, ac: 14, ai: 'smart', undead: true,
    attack: { name: 'Recensione demolitrice', bonus: 4, dice: [1, 10], plus: 1 },
  ...
  gemello_sbagliato: {
    ...
    maxHp: 24, ac: 14, ai: 'smart', undead: true,
    attack: { name: 'La frase che fa più male', bonus: 4, dice: [1, 8], plus: 2 },
  ...
  sonnambulo: {
    ...
    maxHp: 15, ac: 12, ai: 'random', undead: true,
    attack: { name: 'Presa molle', bonus: 3, dice: [1, 8], plus: 0 },
  ...
  mercante_guardia: {
    ...
    maxHp: 20, ac: 14, ai: 'smart', undead: true,
    attack: { name: 'Pignoramento', bonus: 4, dice: [1, 10], plus: 1 },
  ...
  bozzolo_guardiano: {
    ...
    attack: { name: 'Filo grigio', bonus: 5, dice: [2, 6], plus: 2 },
  ...
  eleinad_maschera: {
    ...
    maxHp: 45, ac: 16, ai: 'smart', undead: true, boss: true, lifesteal: true,
    attack: { name: 'Argomento Fantoccio', bonus: 6, dice: [2, 8], plus: 1 },
  ...
  eleinad_vero: {
    ...
    maxHp: 60, ac: 16, ai: 'smart', undead: true, boss: true, lifesteal: true,
    attack: { name: 'Il Grigiore in persona', bonus: 7, dice: [2, 8], plus: 2 },
