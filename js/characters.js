...
const HEROES = [
  {
    ...
    abilities: [
      ...
      { id: 'schiacciata', name: 'Punto Debole', uses: 2, type: 'mark',
        desc: 'Studia la struttura e indica dove colpire: per 2 round TUTTI gli attacchi contro quel nemico hanno VANTAGGIO.' },
    ],
