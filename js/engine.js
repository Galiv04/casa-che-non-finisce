...
const Engine = (() => {
  ...
  function showRevive() {
    ...
    box.innerHTML = `<h2>🗝 Rientra nella Casa</h2>
      <p style="color:var(--text-dim);margin-bottom:10px">Ne siete già usciti una volta: adesso la Casa vi lascia scegliere DA DOVE rientrare. Tutti presenti, zaino e conoscenze preparati per il capitolo scelto.</p>
      ${rows}
